    ...
    <div className="space-y-12 animate-fade">
      <div className="space-y-3">
        ...
        <p className="text-white/30 text-sm max-w-xl font-medium">
          A structured spiritual growth plan for your congregation based on the core sermon themes.
        </p>
      </div>
      ...
      <div className="space-y-8">
        {devotional.map((day, index) => (
          <div
            key={index}
            className="glass-card !p-0 overflow-hidden border-white/5 hover:border-emerald-500/30 transition-all duration-500 group"
          >
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-32 bg-emerald-500/5 border-b md:border-b-0 md:border-r border-white/5 flex items-center justify-center p-8 group-hover:bg-emerald-500/10 transition-colors">
                <div className="text-center">
                  <p className="text-[10px] font-bold text-emerald-500 uppercase tracking-[0.2em] mb-1">
                    Day
                  </p>
              ...
              <div className="flex-1 p-8 space-y-8">
                <div className="space-y-2">
                  <h3 className="text-2xl font-extrabold text-white tracking-tighter group-hover:text-emerald-500 transition-colors">
                    {day.title}
                  </h3>
