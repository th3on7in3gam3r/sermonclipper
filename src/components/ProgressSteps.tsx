          ...
          return (
            <React.Fragment key={step.id}>
              <div className="flex flex-col items-center gap-3 min-w-0 group">
                ...
                <span
                  className={`text-[10px] font-bold uppercase tracking-[0.2em] whitespace-nowrap transition-colors duration-500 ${
              ...
              {!isLast && (
                <div
                  className={`flex-1 h-[1px] mx-4 mb-8 transition-all duration-1000 ${
